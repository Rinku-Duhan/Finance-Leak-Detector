...
with st.expander("Don't have a statement handy? Download a sample to try it"):
    st.write(
        "This is a realistic synthetic statement with a duplicate charge, a subscription "
        "price increase, and a dormant subscription baked in \u2014 download it, then upload "
